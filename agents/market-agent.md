...
2. Use the tools declared in the skill's `tools.yaml` to fetch daily transaction data from Sectors v2
3. Produce a MarketEvidence JSON: performance, volatility, evidence_freshness, cache_hit
