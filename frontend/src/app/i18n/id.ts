export default {
  ...
  'settings.section_mcp': 'MCP & Akses API',
  'settings.section_mcp_hint': 'Buat token untuk agen non-web (MCP, Claude Code, Cursor, opencode…). Setiap token mewakili akun Anda — kunci Sectors, cache bukti, dan kredit yang sama.',
  'settings.mcp_signin_required': 'Masuk untuk mengelola token API.',
  'settings.mcp_token_name_placeholder': 'mis. laptop, claude-code',
  'settings.mcp_create': 'Buat token',
  'settings.mcp_creating': 'Membuat…',
  'settings.mcp_new_token': 'Salin token ini sekarang — tidak akan ditampilkan lagi:',
  'settings.mcp_copy': 'Salin',
  'settings.mcp_copied': 'Tersalin',
  'settings.mcp_empty': 'Belum ada token.',
  'settings.mcp_created': 'dibuat',
  'settings.mcp_last_used': 'terakhir dipakai',
  'settings.mcp_never_used': 'belum',
  'settings.mcp_revoke': 'Cabut',
  'settings.mcp_env_hint': 'Berikan ke harness Anda sebagai NARAGATE_TOKEN, bersama NARAGATE_BACKEND_URL.',
