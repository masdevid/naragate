export default {
  ...
  'settings.sectors_bound_ip': 'Kunci akan terikat ke IP Anda ({{ip}}). Anda dapat menambah IP lain yang diizinkan dari halaman Pengaturan.',
  'settings.sectors_owner_info': 'Kunci terikat ke IP Anda ({{ip}}). Anda dapat menambah IP lain yang diizinkan memakai kunci ini.',
  'settings.sectors_non_owner_info': 'Kunci dikelola dari IP ({{owner}}). IP yang diizinkan: {{ips}}.',
  'settings.sectors_ips_title': 'IP yang Diizinkan',
  'settings.sectors_add_ip': 'Tambah IP',
  'settings.sectors_remove_ip': 'Hapus',
  'settings.sectors_add_ip_placeholder': 'Tambahkan IP (contoh: 203.0.113.10)',
  'settings.sectors_ip_added': 'IP ditambahkan',
  'settings.sectors_ip_removed': 'IP dihapus',
  'settings.sectors_ip_error': 'Gagal memperbarui IP',
