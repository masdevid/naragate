export default {
  ...
  'login.api_key': 'Sectors API Key',
  'login.optional': 'optional',
  'login.api_key_hint': 'Optional — you can add or change this later in Settings.',
  'login.email': 'Email',
  ...
  'settings.section_mcp': 'MCP & API Access',
  'settings.section_mcp_hint': 'Mint a token for non-web agents (MCP, Claude Code, Cursor, opencode…). Each token acts as your account — the same Sectors key, evidence cache and credits.',
  'settings.mcp_signin_required': 'Sign in to manage API tokens.',
  'settings.mcp_token_name_placeholder': 'e.g. laptop, claude-code',
  'settings.mcp_create': 'Create token',
  'settings.mcp_creating': 'Creating…',
  'settings.mcp_new_token': 'Copy this token now — it will not be shown again:',
  'settings.mcp_copy': 'Copy',
  'settings.mcp_copied': 'Copied',
  'settings.mcp_empty': 'No tokens yet.',
  'settings.mcp_created': 'created',
  'settings.mcp_last_used': 'last used',
  'settings.mcp_never_used': 'never',
  'settings.mcp_revoke': 'Revoke',
  'settings.mcp_env_hint': 'Give it to your harness as NARAGATE_TOKEN, alongside NARAGATE_BACKEND_URL.',
  ...
  'usage.section_account': 'Sectors Account (authoritative)',
  'usage.section_instance': 'This Instance (local ledger)',
  'usage.account_tier': 'Plan',
  'usage.account_credits': 'Credits',
  'usage.account_promo': 'Promo Credits',
  'usage.account_success': 'Successful Calls',
  'usage.account_error': 'Error Calls',
  'usage.account_spent': 'Credits Burned (observed)',
  'usage.account_unavailable': 'Sectors account usage not available',
  'usage.account_hint': 'Set SECTORS_OAUTH_ACCESS_TOKEN (or refresh credentials) in .env. See references/sectors-account-usage.md.',
  'usage.account_expires': 'expires',
