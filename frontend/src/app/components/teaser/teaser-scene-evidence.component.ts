...
@Component({
  ...
  styles: [`
    ...
    .badge { position: absolute; top: 32px; left: 40px; opacity: 0; animation: evBadgeIn .45s ease-out forwards; animation-delay: 3.8s; }
    .badge .wordmark { font-size: 22px; }
    @keyframes evBadgeIn { to { opacity: 1; } }

    .claim-wrap { position: absolute; top: 150px; left: 64px; width: 620px; opacity: 0; animation: evFadeUp .5s ease-out forwards; animation-delay: 4.2s; }
    ...
    .claim-box {
      ...
      animation: evType 1.3s steps(46,end) forwards; animation-delay: 4.4s;
    }
    ...
    .row.r1 { animation-delay: 5.6s; }
    .row.r2 { animation-delay: 6.05s; }
    .row.r3 { animation-delay: 6.5s; }
    .row.r4 { animation-delay: 6.95s; }
    ...
    .gauge-wrap {
      ...
      opacity: 0; animation: evFadeUp .5s ease-out forwards; animation-delay: 5.0s;
    }
    ...
    .gauge-wrap .fill {
      ...
      animation: evDraw 2s cubic-bezier(.2,.8,.2,1) forwards; animation-delay: 5.4s;
    }
    ...
    .gauge-verdict {
      ...
      opacity: 0; animation: evFadeUp .4s ease-out forwards; animation-delay: 7.6s;
    }
    ...
    .caption {
      ...
      opacity: 0; animation: evFadeUp .6s ease-out forwards; animation-delay: 8.6s;
    }
  `],
})
export class TeaserSceneEvidenceComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.timers.push(setTimeout(() => this.countTo(63, 2000), 5400));
  }
