...
@Component({
  ...
  template: `
    <div class="scene">
      ...
      <div class="dev">oleh <b>DepodTech</b></div>
    </div>
  `,
  styles: [`
    ...
    .dev {
      ...
      opacity: 0; animation: ctFadeUp .5s ease-out forwards; animation-delay: 6.6s;
    }
    .dev b { color: var(--text-primary); font-weight: 600; }
